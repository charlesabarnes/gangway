  ...
  template: `
    <main class="flex min-h-dvh items-center justify-center px-6 py-12">
      <div class="w-full max-w-sm">
        ...
        <p class="mt-1.5 text-sm text-neutral-600 dark:text-neutral-400"><ng-content select="[lede]" /></p>
...
export const ALERT = 'rounded-md border border-red-200 bg-red-50 px-3 py-2.5 text-sm text-red-800 dark:border-red-900/60 dark:bg-red-950/40 dark:text-red-300';
