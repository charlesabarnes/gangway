...
import { artifactIndex, kitConfig, RENDER_PATH, renderAssets } from "./artifact-render.ts";
import {
  collectStatic,
  nginxConf,
  q,
...
function renderArtifact(b: Build): Rendered {
  ...
  return {
    dockerfile:
      ...
      `COPY .gangway/render/ ${html}/${RENDER_PATH}/\nCOPY .gangway/kit-config.json ${html}/${RENDER_PATH}/config.json\n` +
      (markdown ? `COPY .gangway/index.html ${html}/index.html\n` : "") +
      `${b.env}\n`,
    files: b.files,
    assets: files,
