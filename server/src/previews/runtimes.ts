...
export function script(
  ...
  const lines = [
    "#!/bin/sh",
    `# Generated by gangway (ADR-0016): ${what}. Rewritten on every build.`,
    "set -e",
  ];
...
const header = (id: RuntimeId) =>
  `# Generated by gangway for the "${id}" runtime (ADR-0015/0016). Edits here are overwritten on every build.\n`;
