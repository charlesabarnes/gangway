...
export class RolePermissions {
  ...
  /** Returns what the role held before, for the audit entry. */
  set(roleId: string, permissions: readonly Permission[]): { old: Permission[]; new: Permission[] } {
    ...
    this.reload();
    return { old, new: [...this.for(roleId)].sort() };
  }
}
