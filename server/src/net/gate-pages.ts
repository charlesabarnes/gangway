...
// The "Chart" look of the web UI's login card. The CSP allows no fonts or images, so the mark is
// inlined from the same files the UI serves, and the fonts fall back when Plex is not installed.
const PAGE_CSS = `
