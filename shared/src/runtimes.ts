...
export type Runtime = {
  ...
  image: string;
  /** The port the container listens on. The runtime sets `$PORT` to it. */
  port: number;
  /** Entry files, first match wins. Empty: the runtime has no entry (static, php). */
  entries: readonly string[];
  /** What a new preview of this runtime starts with. */
...
export const RUNTIMES: readonly Runtime[] = [
  {
    ...
    image: "nginxinc/nginx-unprivileged:1.29-alpine", port: 8080, entries: [],
    starter: {
...
`,
  ...
  },
  {
    ...
    image: "node:24-alpine", port: 3000, entries: ["server.js", "index.js", "app.js", "main.js"],
    starter: {
      "package.json": `{
  "name": "hello",
  "private": true,
...
`,
  ...
  },
  {
    ...
    image: "oven/bun:1.4.2-alpine", port: 3000,
  ...
  },
  {
    ...
    image: "denoland/deno:alpine-2.9.7", port: 8000,
  ...
  },
  {
    ...
    image: "node:24-bookworm-slim + workerd 1.20260922.1", port: 8080,
...
`,
  ...
  },
  {
    ...
    image: "python:3.14-slim", port: 8000, entries: ["main.py", "app.py", "server.py"],
    starter: {
      "main.py": `import os
...
`,
  ...
  },
  {
    ...
    image: "php:8.5-apache", port: 80, entries: [],
    starter: {
      "index.php": `<?php
...
/** Which runtime a set of relative file paths looks like. Anything else is a static site. */
